...
**Start here:** [Agents don't need smarter models, they need a map](https://horiacristescu.github.io/karto-plugin/) — the long-form article on the SSP method: why agents fail, the named-state middle layer, tail-to-head induction from traces, the blame ladder, and running the map in production.
